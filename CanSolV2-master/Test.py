...
class UI:
    ...
    def invoke(self):
        ...
        label_one = Label(master, text = 'CanSol - Predicts Reliable',fg='#00004d',bg='white')
        label_one.config(font=("Times", 30,"bold italic"))

        label_one.place(x=450,y=20)
        ...
        PlotAcc=Button(master, text='Trained-Model', command=self.plotAccuracy,bg='#00004d',fg='white')
        PlotAcc.place(x=170, y=540, width=120,height=30)
        confusionBtn=Button(master, text='Confusion Matrix',command=self.confusionmatrix,bg='#00004d',fg='white')
        confusionBtn.place(x=540, y=540, width=120,height=30)
        predictBtn=Button(master, text='Binary Classification', command=self.predict,bg='#00004d',fg='white')
        predictBtn.place(x=900, y=540, width=120, height=30)
